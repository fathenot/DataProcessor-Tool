...
namespace DataProcessor.source.Generics_Series
{
    public partial class Series<DataType>
    {
        ...
        public DataProcessor.source.Non_Generics_Series.Series ConvertToNonGenerics()
        {
            List<object?> values = new List<object?>();
            values.AddRange(this.values);
            return new DataProcessor.source.Non_Generics_Series.Series(values, this.name, this.index);
        }
    }
}
